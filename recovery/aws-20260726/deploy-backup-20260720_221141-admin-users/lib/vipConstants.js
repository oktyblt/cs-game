...
const VIP_FEATURES = Object.freeze({
  silver: [
    'Scoreboard’da VIP / COP★ görünürlüğü',
    'Rezerve slot',
    'Votekick bağışıklığı',
    'Rank / profil VIP rozeti',
  ],
  gold: [
    'Silver’daki tüm ayrıcalıklar',
    'Klasik VIP modelleri',
    'Round başı para +$300–500',
    'Ücretsiz kevlar',
    'VIP oda erişimi',
    '/vip menü',
  ],
  platinum: [
    ...
    'Clan tag',
    'Daha yüksek para veya CT defuse kiti',
    'Voteban / mute koruması',
    'Ayda 1 harita önerisi',
