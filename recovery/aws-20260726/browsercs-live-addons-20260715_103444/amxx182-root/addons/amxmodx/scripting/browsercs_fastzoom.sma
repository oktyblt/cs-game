...
#define FIRE_LOCK_AWP 1.45
#define FIRE_LOCK_SCOUT 1.25
...
public OnSniperDeploy_Post(weapon)
{
	...
	// Unlock ItemPostFrame + secondary (scope) immediately.
	// Keep primary fire delayed until the draw animation would finish.
