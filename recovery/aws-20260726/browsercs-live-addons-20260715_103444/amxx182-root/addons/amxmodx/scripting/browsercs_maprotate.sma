...
/**
 * Platinum VIP onerilerini oylama menusune pinler.
 * Satir: map|port|userId|unix
 * port=0 -> herhangi bir sunucu; aksi halde sadece eslesen port.
 * Kullanilan satirlar kuyruktan silinir.
 */
