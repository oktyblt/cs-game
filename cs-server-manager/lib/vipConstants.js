...
const VIP_FEATURES = Object.freeze({
  silver: [
    ...
    'F2 veya /vip ile VIP modu aç/kapa',
  ],
  gold: [
    'Silver’daki tüm ayrıcalıklar',
    'VIP ODA’ya giriş (sadece Gold/Platinum)',
    'Klasik VIP oyuncu modelleri (F4 görsel menü)',
    'Round başı ekstra para + otomatik kalkan (kevlar)',
