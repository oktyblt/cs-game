  ...
  async fetch(request, env) {
    ...
    if (path === "/relay") {
      ...
      if (role === "host") {
        ...
        const cleanupHost = /* @__PURE__ */ __name(() => {
          room.host = null;
        ...
        const cleanupClient = /* @__PURE__ */ __name(() => {
...
//# sourceMappingURL=bundledWorker-0.12553648606228796.mjs.map
