...
async function initEngine(mapName, connectPort = null, isHost = false) {
  ...
  try {
    ...
    const [
      ...
      cachedFetch('/wasm/dlls/cs_emscripten_wasm32_v35.wasm'),
      cachedFetch('/wasm/cl_dlls/client_emscripten_wasm32_v35.wasm'),
      cachedFetch('/wasm/cl_dlls/menu_emscripten_wasm32_v35.wasm'),
    ...
    setProgress(65, 'Xash3D WASM instance oluşturuluyor...');
      ...
      libraries: {
        menu:   '/wasm/cl_dlls/menu_emscripten_wasm32_v35.wasm',
        client: '/wasm/cl_dlls/client_emscripten_wasm32_v35.wasm',
        server: '/wasm/dlls/cs_emscripten_wasm32_v35.wasm',
        render: {
      ...
      filesMap: {
        ...
        'cl_dlls/menu_emscripten_wasm32.wasm':   '/wasm/cl_dlls/menu_emscripten_wasm32_v35.wasm',
        'cl_dlls/client_emscripten_wasm32_v35.wasm': '/wasm/cl_dlls/client_emscripten_wasm32_v35.wasm',
        'dlls/cs_emscripten_wasm32.wasm':        '/wasm/dlls/cs_emscripten_wasm32_v35.wasm',
        'dlls/hl_emscripten_wasm32.wasm':        '/wasm/dlls/cs_emscripten_wasm32_v35.wasm',
      },
      ...
      module: {
        ...
        preRun: [(em) => {
          ...
          em.FS.writeFile('/cstrike/cl_dlls/client_emscripten_wasm32_v35.wasm', csClientBuffer);
