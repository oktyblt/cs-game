...
async function initEngine(mapName, connectPort = null, isHost = false) {
  ...
  try {
    ...
    const [
      ...
      cachedFetch('/wasm/dlls/cs_emscripten_wasm32_v32.wasm'),
      cachedFetch('/wasm/cl_dlls/client_emscripten_wasm32_v32.wasm'),
      cachedFetch('/wasm/cl_dlls/menu_emscripten_wasm32_v32.wasm'),
    ...
    setProgress(65, 'Xash3D WASM instance oluşturuluyor...');
      ...
      libraries: {
        menu:   '/wasm/cl_dlls/menu_emscripten_wasm32_v32.wasm',
        client: '/wasm/cl_dlls/client_emscripten_wasm32_v32.wasm',
        server: '/wasm/dlls/cs_emscripten_wasm32_v32.wasm',
        render: {
      ...
      filesMap: {
        ...
        'cl_dlls/menu_emscripten_wasm32.wasm':   '/wasm/cl_dlls/menu_emscripten_wasm32_v32.wasm',
        'cl_dlls/client_emscripten_wasm32_v32.wasm': '/wasm/cl_dlls/client_emscripten_wasm32_v32.wasm',
        'dlls/cs_emscripten_wasm32.wasm':        '/wasm/dlls/cs_emscripten_wasm32_v32.wasm',
        'dlls/hl_emscripten_wasm32.wasm':        '/wasm/dlls/cs_emscripten_wasm32_v32.wasm',
      },
      ...
      module: {
        ...
        preRun: [(em) => {
          ...
          em.FS.writeFile('/cstrike/cl_dlls/client_emscripten_wasm32_v32.wasm', csClientBuffer);
