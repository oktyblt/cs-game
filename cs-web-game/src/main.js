...
async function initEngine(mapName, connectPort = null, isHost = false) {
  ...
  try {
    ...
    const [
      ...
      cachedFetch('/wasm/dlls/cs_emscripten_wasm32_v44.wasm'),
    ...
    xash = new Xash3DWebSocket({
      ...
      libraries: {
        ...
        server: '/wasm/dlls/cs_emscripten_wasm32_v44.wasm',
        render: {
      ...
      filesMap: {
        ...
        'dlls/cs_emscripten_wasm32.wasm': '/wasm/dlls/cs_emscripten_wasm32_v44.wasm',
        'dlls/hl_emscripten_wasm32.wasm': '/wasm/dlls/cs_emscripten_wasm32_v44.wasm',
      },
