...
async function initEngine(mapName, connectPort = null, isHost = false) {
  ...
  try {
    ...
    const [
      ...
      cachedFetch('/wasm/dlls/cs_emscripten_wasm32_v38.wasm'),
      cachedFetch('/wasm/cl_dlls/client_emscripten_wasm32_v66.wasm'),
      cachedFetch('/wasm/cl_dlls/menu_emscripten_wasm32_v37.wasm'),
    ...
    xash = new Xash3DWebSocket({
      ...
      libraries: {
        menu: '/wasm/cl_dlls/menu_emscripten_wasm32_v37.wasm',
        client: '/wasm/cl_dlls/client_emscripten_wasm32_v66.wasm',
        server: '/wasm/dlls/cs_emscripten_wasm32_v38.wasm',
        render: {
      ...
      filesMap: {
        ...
        'cl_dlls/menu_emscripten_wasm32.wasm': '/wasm/cl_dlls/menu_emscripten_wasm32_v37.wasm',
        'cl_dlls/client_emscripten_wasm32.wasm': '/wasm/cl_dlls/client_emscripten_wasm32_v66.wasm',
        'dlls/cs_emscripten_wasm32.wasm': '/wasm/dlls/cs_emscripten_wasm32_v38.wasm',
