...
(function () {
  ...
  function ensureMenu() {
    ...
    el.innerHTML = [
      ...
      '<p>İki ayrı paket: Altın (*_vip_*) ve Kırmızı–Beyaz (*_viprw_*). Oyunda anında değişir.</p>',
      '<div class="choices">',
      '<button type="button" data-skin="gold">Altın (Gold)<span class="sub">models/*_vip_*.mdl</span></button>',
      '<button type="button" data-skin="rw" class="rw">Kırmızı–Beyaz<span class="sub">Ayrı paket models/*_viprw_*.mdl</span></button>',
      '</div>',
